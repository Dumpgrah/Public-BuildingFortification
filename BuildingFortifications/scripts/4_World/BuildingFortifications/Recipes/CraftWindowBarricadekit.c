class CraftWindowBarricadekit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Window Barricade Kit";
		...
		//result1
		AddResult("BF_WindowBarricadeKit");//add results here
...
class CraftWindowBarricadeMedkit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Window Medium Barricade Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("BF_WindowBarricadeMedKit");//add results here
