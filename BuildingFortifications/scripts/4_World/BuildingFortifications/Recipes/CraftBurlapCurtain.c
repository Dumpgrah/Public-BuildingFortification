class CraftBurlapCurtain extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Burlap Cloth";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BurlapStrip");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BurlapCurtain");//add results here
